...
BeginPackage["susyQMinusCode`",{"utilities`"}]
...
factor[\[CapitalDelta]_,\[CapitalDelta]p_]:=(-1)^(\[CapitalDelta]+\[CapitalDelta]p+1/2) Sqrt[Gamma[2\[CapitalDelta]]Gamma[2\[CapitalDelta]p]]/Gamma[\[CapitalDelta]+\[CapitalDelta]p+1/2]
