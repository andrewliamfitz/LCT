...
BeginPackage["susyQPlusCode`",{"utilities`"}]
...
factor2[\[CapitalDelta]_,\[CapitalDelta]p_]:=1/Sqrt[2]Sqrt[Gamma[2\[CapitalDelta]]Gamma[2\[CapitalDelta]p]]/Gamma[\[CapitalDelta]+\[CapitalDelta]p-1/2]*(-1)^(\[CapitalDelta]+\[CapitalDelta]p-1/2)


factor3[\[CapitalDelta]_,\[CapitalDelta]p_]:=1/Sqrt[8\[Pi]]Sqrt[Gamma[2\[CapitalDelta]]Gamma[2\[CapitalDelta]p]]/Gamma[\[CapitalDelta]+\[CapitalDelta]p-1/2]*(-1)^(\[CapitalDelta]+\[CapitalDelta]p+1/2)
...
primBlock=Function[{level1,level2},
	...
	ck'= #2[[kR+1]]
	mkk'=monomialBlock[...]
	At the end, multiply by factor2[\[CapitalDelta],\[CapitalDelta]p], which
	combines the factors from the Fourier transforms of 2- and 3-point functions. *)
		...
		level1["states"],
		level2["states"],
		1]*factor2[nBL+3/2nFL+degBL+degFL+lL,(nBL+dnB)+3/2(nFL+dnF)+degBR+degFR+lR]
	]
];
...
primBlockInt=Function[{level1,level2},
	With[{
		...
		level1["states"],
		level2["states"],
		1]*factor3[nBL+3/2nFL+degBL+degFL+lL,nBR+3/2(nFL+dnF)+degBR+degFR+lR]
	]
];
